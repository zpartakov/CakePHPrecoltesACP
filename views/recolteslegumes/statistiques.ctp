...
<th>prixminBIO</th>
<th>prixmaxBIO</th>
<th>Prix moyen</th><th>Valeur</th></tr>";

//def variables
	$i=0; $i2=0; $prixtot=0; $qGP=0; $qPP=0; $qT=0; $qGPtot=0; $qPPtot=0; $qTot=0; $prixtot=0; $prixmoyenT=0;
	...
	echo "<tr class=\"".$class ."\">";
		...
		echo $prixmaxBIO;
		echo "</td><td>";
		$q=intval(((mysql_result($sqll,$i,'nb_GP')*$qGP)+(mysql_result($sqll,$i,'nb_PP')*$qPP))/$diviseur);
#echo "<font color=red>xxxx</font>";
		...
		echo "</td><td>";
		echo "<a href=\"../recolteslegumes/edit/".mysql_result($sqll,$i,'rl.id') ."\">";
		echo intval($pm*$q) .".-" ;
		echo "</a>";
		$prixtot=$prixtot+intval($pm*$q);
	echo "</td></tr>";
	$i2++; $i++;
	}
//totaux
